package com.dezdeqness.core.ui.views.picker
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Box(
                ...
                Row(
                    ...
                    WheelView(
                        ...
                        onItemSelected = { selectedTime = selectedTime.copy(hours = hours[it]) },
                        content = { index, alpha ->
                            Text(
            ...
            AppPrimaryButton(
                ...
                onClick = { onSaveTime(selectedTime.hours, selectedTime.minutes) },
            )
        }
    }
}
...
private fun SelectorView(modifier: Modifier = Modifier, visibleItems: Int) {
    Column(modifier.fillMaxSize()) {
        ...
        Column(
            modifier = Modifier.weight(1.13f).fillMaxWidth(),
